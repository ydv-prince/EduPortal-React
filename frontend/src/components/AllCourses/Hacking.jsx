    ...
    <>
      ...
      >
        ...
        <section className="flex flex-col items-center">
          ...
          <p className="items-center ml-3 text-4xl text-white mt-14 max-md:mt-10 max-md:max-w-full">
            ...
            <br />
            online ethical hacker course in India. This training program is{" "}
            <br />
          ...
          <div className="flex flex-wrap gap-5 justify-between mt-36 w-full text-3xl text-black max-w-[1222px] max-md:mt-10 max-md:max-w-full">
            <button className="ml-8 px-16 py-5 border-2 border-fuchsia-700 border-solid bg-stone-950 rounded-[50px] max-md:px-5 text-white hover:bg-fuchsia-900 transition-colors">
              Networking
            </button>
            <div className="flex flex-wrap gap-10 max-md:max-w-full">
              <button className="grow px-20 py-5 mr-32 whitespace-nowrap border-2 border-fuchsia-700 border-solid bg-stone-950 rounded-[50px] w-fit max-md:px-5 text-white hover:bg-fuchsia-900 transition-colors">
                Linux
              </button>
        ...
        <div className="flex gap-5 max-md:flex-col">
          ...
          <aside className="flex flex-col items-start self-stretch w-2/5 my-auto text-white ml-9 max-md:mt-10">
            ...
            <button
              ...
              onClick={() => navigate("/HackingPayment")}
            >
              Buy Now
            </button>
            ...
            <button
              ...
              onClick={() =>
                window.open(
                  "https://www.youtube.com/watch?v=vK4Mno4QYqk",
                  "_blank"
                )
              }
            >
              Learn basic of Hacking
            </button>
          </aside>
        </div>
      </section>
      ...
      <section className="flex flex-col items-center w-full">
        ...
        <button
          ...
          onClick={() => navigate("/HackingSyllabus")}
        >
