          ...
          <div className="flex gap-5 max-md:flex-col">
                    ...
                    <div className="w-1/2 max-md:w-full">
                      <div className="mt-4 max-md:mt-8">
                        <div className="flex flex-col text-lg text-white">
                          <h2>Online Flutter App</h2>
                          <h2>Development Course</h2>
                          <p className="mt-5">₹6999</p>
                        </div>
            ...
            <div className="w-[40%] max-md:w-full">
              <aside className="flex flex-col w-full pt-6 text-white rounded-2xl bg-stone-950">
                ...
                <button className="px-12 py-4 mt-4 text-lg rounded-lg bg-fuchsia-700 hover:bg-fuchsia-600" onClick={()=> {navigate("/PayFlutter")}}>
                  Proceed to Checkout
                </button>
              </aside>
            </div>
