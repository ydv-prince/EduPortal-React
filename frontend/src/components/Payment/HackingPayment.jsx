...
export default function HackingPayment() {
          ...
          <div className="flex gap-5 max-md:flex-col">
            ...
            <div className="w-[40%] max-md:w-full">
              <aside className="flex flex-col w-full pt-6 text-white rounded-2xl bg-stone-950">
                ...
                <button className="px-12 py-4 mt-4 text-lg rounded-lg bg-fuchsia-700 hover:bg-fuchsia-600" onClick={()=> {navigate("/PayHacking")}}>
                  Proceed to Checkout
                </button>
              </aside>
            </div>
